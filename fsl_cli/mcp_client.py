"""MCP client for fsl-cli — supports all official transports and auth types.
...
def run_oauth2_pkce_flow(
    ...
    class _Handler(BaseHTTPRequestHandler):
        def do_GET(self):
            ...
            self.end_headers()
            self.wfile.write(
                b"<html><body><h2>fsl-cli: Authorization complete. "
...
class StdioMCPClient(MCPClient):
    ...
    def initialize(self) -> dict:
        r = _result(self._send(_rpc("initialize", {
            ...
            "capabilities": {"tools": {}},
            "clientInfo": {"name": "fsl-cli", "version": "0.1.0"},
        })))
