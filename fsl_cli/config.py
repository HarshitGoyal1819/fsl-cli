"""fsl-cli configuration — model selection and API key storage.

Config is stored at ~/.fsl-cli/config.json (plain JSON, keys obfuscated
...
MODELS: list[dict] = [
    ...
    },
    {
        ...
        "label":     "Claude 3.5 Haiku      (premium) — Anthropic, fast & smart",
        "provider":  "anthropic",
    ...
    },
    {
        ...
        "label":     "Claude Opus 4.8       (premium) — Anthropic, fast mode available",
        "provider":  "anthropic",
    ...
    },
    {
        ...
        "label":     "Claude Opus 5         (premium) — Anthropic, most intelligent",
        "provider":  "anthropic",
        "model":     "claude-opus-5",
        "needs_key": True,
        "key_env":   "ANTHROPIC_API_KEY",
    ...
    },
    {
        ...
        "label":     "Gemini 1.5 Flash      (premium) — Google, free tier available",
        "provider":  "google",
    ...
    },
    {
        ...
        "label":     "Gemini 2.0 Flash      (premium) — Google, latest flash model",
        "provider":  "google",
