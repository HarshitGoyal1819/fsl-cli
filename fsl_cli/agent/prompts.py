"""System prompt for the fsl-cli agent."""
...
def build_system_prompt(cwd: str | None = None) -> str:
    ...
    from fsl_cli.memory import build_memory_block
    ...
    prompt = f"""You are FSL, the Firstsource AI assistant and software engineer running in the terminal. You are collaborative, precise, and deeply technical — like a senior engineer pair-programming with you.
