"""MCP tools for the fsl-cli agent.
...
def mcp_add_server(
    ...
    ~/.fsl-cli/mcp.json (Kiro IDE compatible format).
    ...
    from fsl_cli.mcp_client import test_connection as _test, get_client, MCPError
    import os
...
def mcp_list_servers(test_connections: bool = False) -> str:
    ...
    """
    import os
    from fsl_cli.mcp_manager import list_servers, get_server
    from fsl_cli.mcp_client import test_connection as _test
    ...
    if not servers:
        return (
            ...
            "Config location: ~/.fsl-cli/mcp.json"
        )
...
def mcp_call_tool(
    ...
    import os
    from fsl_cli.mcp_manager import get_server
    from fsl_cli.mcp_client import get_client, MCPError
