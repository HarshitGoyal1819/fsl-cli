# =============================================================================
# add_to_path.ps1
# Adds the fsl-cli install directory to the system PATH on Windows.
# Run as Administrator after a manual / silent install.
#
#   Usage:
#     powershell -ExecutionPolicy Bypass -File add_to_path.ps1 [-InstallDir "C:\fsl-cli"]
# =============================================================================

param(
    [string]$InstallDir = "$env:ProgramFiles\fsl-cli"
)
...
if ($currentPath -like "*$InstallDir*") {
    Write-Host "fsl-cli is already in PATH: $InstallDir"
    exit 0
}
...
Write-Host "   Open a new CMD or PowerShell window and type:  fsl-cli"
